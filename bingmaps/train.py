...
model = tf.keras.Sequential([
    ...
    # layers.Conv2D(3, 5, padding='same', activation='tanh'), # this seems like a bit of a brute force approach to handing a 3 channel image to resnet, 
        ...
        include_top=True,
        weights=None,#'imagenet', # if I don't use the pre trained weights from image net, does it matter that i don't use the preprocessing step which reorders RGB to BGR and zero-centers wrt imagenet?
...
model.save_weights('/gws/nopw/j04/aopp/manshausen/saved_bing_models/1400_aggressive_da.h5')  # always save your weights after training or during training